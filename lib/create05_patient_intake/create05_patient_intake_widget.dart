...
import 'create05_patient_intake_model.dart';
export 'create05_patient_intake_model.dart';

class Create05PatientIntakeWidget extends StatefulWidget {
  const Create05PatientIntakeWidget({super.key});

  @override
  State<Create05PatientIntakeWidget> createState() =>
      _Create05PatientIntakeWidgetState();
}

class _Create05PatientIntakeWidgetState
    extends State<Create05PatientIntakeWidget> {
  late Create05PatientIntakeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Create05PatientIntakeModel());
